...
{
  // anynomous author: setting optimization
  if(isOptimization()) m->setOptimization();
...
void Theory::setOptimization(){
  _isOptimization = OPT_TYPE::WAITING;
  // std::cout<<"Theory::setOptimization"<<std::endl;
  // inference manager set optimization
  getInferenceManager()->setOptimization();
}
void Theory::setObjective(OPT_TYPE _isOpt, Node& e){
  // std::cout<<"Theory::setObjective"<<std::endl;
  _isOptimization = _isOpt;
  objectiveVariable = e;
}
bool Theory::isOptimization() const{
