...
Node TheoryModel::getModelValue(TNode n) const
{
  ...
  Node ret = n;
  if(isOptimization()){
    // anynomous author: in optimization
    ret = d_equalityEngine->getRepresentative(n);
...
void TheoryModel::setOptimization(){
  _isOptimization = true;
  // std::cout<<"TheoryModel::setOptimization"<<std::endl;
}
bool TheoryModel::isOptimization() const{
  return _isOptimization;
}
