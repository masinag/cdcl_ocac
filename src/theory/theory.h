...
class Theory : protected EnvObj
{
 ...
 public:
  ...
  // anynomous author: optimization state setting to nonlinear extension
  ...
  virtual void assertOptBound() {}
  virtual bool missBound() const { return false; }
  virtual Node getBoundValue(const Node& e) const{ return Node(); }
  virtual Node getOptimizedValue(const Node& e) const{ return Node(); }
  virtual bool isOptSAT() const{ return false; }
  virtual void buildOptModel(TheoryModel* m) { }
  virtual bool isOptUnbounded() const { return false; };
  virtual bool isOptPosInf() const { return false; }
  virtual bool isOptNegInf() const { return false; }
  virtual bool isOptPosApprox() const { return false; }
  virtual bool isOptNegApprox() const { return false; }
