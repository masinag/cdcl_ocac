...
class TheoryArith : public Theory {
 ...
 public:
  ...
  virtual void assertOptBound() override;
  virtual bool missBound() const override;
  virtual Node getBoundValue(const Node& e) const override;
  virtual Node getOptimizedValue(const Node& e) const override;
  virtual bool isOptSAT() const override;
  virtual void buildOptModel(TheoryModel* m) override;
  virtual bool isOptUnbounded() const override;
  virtual bool isOptPosInf() const override;
  virtual bool isOptNegInf() const override;
  virtual bool isOptPosApprox() const override; // a + \epsilon
  virtual bool isOptNegApprox() const override;
