...
class CVC5_EXPORT Printer
{
 public:
  ...
  /** anynomous author: Print maximize command */
  virtual void toStreamCmdMaximize(std::ostream& out, Node n) const;
  /** anynomous author: Print minimize command */
  virtual void toStreamCmdMinimize(std::ostream& out, Node n) const;
  /** anynomous author: Print get-objective command */
  virtual void toStreamCmdGetObjectives(std::ostream& out) const;
