...
// anynomous author: optimize
void Printer::toStreamCmdMaximize(std::ostream& out, Node n) const
{
  printUnknownCommand(out, "maximize");
}
void Printer::toStreamCmdMinimize(std::ostream& out, Node n) const
{
  printUnknownCommand(out, "minimize");
}
void Printer::toStreamCmdGetObjectives(std::ostream& out) const
{
...
{
  printUnknownCommand(out, "get-model"); // original: ge-model
}
