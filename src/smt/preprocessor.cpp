...
void Preprocessor::setObjective(){
  // std::cout<<"Preprocessor::setObjective"<<std::endl;
  d_processor.setObjective();
}
void Preprocessor::unsetObjective(){
  // std::cout<<"Preprocessor::setObjective"<<std::endl;
  d_processor.unsetObjective();
}
