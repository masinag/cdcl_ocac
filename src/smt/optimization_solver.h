...
class OptimizationResult
{
 public:
  ...
  // anynomous author: 2023-08-16
  bool isPosInfinity() const { return d_infinity == POSTITIVE_INF; }
  bool isNegInfinity() const { return d_infinity == NEGATIVE_INF; }
  bool isPosApprox() const { return d_infinity == POSTITIVE_EPSILON; }
  bool isNegApprox() const { return d_infinity == NEGATIVE_EPSILON; }
  bool isFinite()      const { return d_infinity == FINITE; }
 ...
 private:
  ...
  Node d_value;
  /** whether the result is finite/+infinity/-infinity/a+epsilon/a-epsilon **/
...
class OptimizationSolver : protected EnvObj
{
 public:
   ...
   * @return a boolean variable of Optimization Result
   **/
  bool isSmtModeSat();
