...
std::ostream& operator<<(std::ostream& o, Token t)
{
  switch (t)
  {
    ...
    case Token::GET_OBJECTIVES_TOK: o << "GET_OBJECTIVES_TOK"; break;
    ...
    case Token::UNTERMINATED_STRING_LITERAL:
      ...
      break;
    case Token::MINIMIZE_TOK: o << "MINIMIZE_TOK"; break; // anynomous author: minimize
    case Token::MAXIMIZE_TOK: o << "MAXIMIZE_TOK"; break; // anynomous author: maximize
