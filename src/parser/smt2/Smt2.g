...
@declarations {
  ...
  | /* optimization maximize */
    ...
    term[expr, expr2]
    { 
      cmd->reset(new OptimizeCommand(expr, false));
    }
  | /* optimization minimize */
    ...
    term[expr, expr2]
    { 
      cmd->reset(new OptimizeCommand(expr, true));
    }
    /* get objectives */
  | GET_OBJECTIVES_TOK { }
...
POP_TOK : 'pop';
AS_TOK : 'as';
MAXIMIZE_TOK : 'maximize';
MINIMIZE_TOK : 'minimize';
GET_OBJECTIVES_TOK : 'get-objectives';
