...
// anynomous author: optimize command
class CVC5_EXPORT OptimizeCommand : public Command
{
 protected:
  cvc5::Term d_term;
  bool _isMinimize;
 ...
 public:
  OptimizeCommand(const cvc5::Term& t, bool isMin);
...
class CVC5_EXPORT GetObjectivesCommand : public Command
{
 public:
  GetObjectivesCommand();
  void invoke(cvc5::Solver* solver, parser::SymbolManager* sm) override;
